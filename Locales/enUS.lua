...
L["OPT_EDIT_MODE_DESC"]  = "When enabled, drag the green frame to reposition; previews 5 test boss frames. Test mode exits automatically when turned off or when combat starts."
